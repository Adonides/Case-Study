...
const Languages = {
    ...
    english: {
        ...
        article05: "The strongest defend to traditional learning would be the network, programs and internships offered from those institutes who has the power to partnership with companies. However, these benefits are not equally available to all alumni, but are only provided to a small group of students leaving just the network with the interaction with other students as a very important point. No just that, the main aspect in favor to traditional education I think is the structure, that´s because there are some subjects, career we must use expensives equipments, a very clear example is the studying of medicine, I would say it is almost impossible to buy  a private lab. But maybe a half-time online course would to the job!",
    ...
    portuguese: {
        ...
        article05: "As defesas mais fortes para o aprendizado tradicional serian a rede de contatos, programas e estágios oferecidos por instituições que têm poder de parcerias com empresas. Ah, mas esses benefícios não são para todos os alunos, na maioria das vezes, apenas alguns alunos são incluídos, deixando apenas network junto com a interação com outros alunos como um ponto muito importante. Não apenas estes são os motivos para se matricular nesses intitutos, o principal aspecto que eu pegaria da educação tradicional é a estrutura, digo isso porque tem algumas disciplinas, ou carreira que temos que usar equipamento carissimos, e um exemplo mais fácil seria estudar medicina, eu diria que é quase impossível comprar um laboratório privado. Porém talvez um curso online parcial faria o trabalho! ",
    ...
    spanish: {
        ...
        article05: "Lo que más habla a favor de un curso de educación tradicional son las redes, los programas de apoyo y las prácticas que se conceden en instituciones que tienen conexiones con empresas de la economía libre. Sin embargo, estos beneficios no están disponibles por igual para todos los ex alumnos, sino que sólo se conceden a un pequeño grupo de ellos, dejando solamente el network junto con la interacción con otros estudiantes como un punto muy importante. Por supuesto, hay algunos temas para los que hay que utilizar equipos caros. Un ejemplo muy claro sería la facultad de medicina, yo diría que es casi imposible comprar un laboratorio privado. Aunque un estudio en línea a media jornada también funcionaría!",
